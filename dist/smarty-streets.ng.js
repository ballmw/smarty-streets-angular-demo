angular.module('org.crossroads.smartyStreets.services', [
  'ngResource',
  'smartyStreetsConfig'
]);
/*
 * FACTORIES
 */
angular.module('org.crossroads.smartyStreets.services').factory('SmartyStreetsSuggestionFactory', [
  '$resource',
  '$q',
  'SmartyToken',
  function ($resource, $q, SmartyToken) {
    ...
    getSuggestions = function (suggestion) {
      var defer = $q.defer();
      smartyStreets.get({ prefix: suggestion }, function (result) {
...
]).factory('SmartyStreetsValidationFactory', [
  '$resource',
  '$q',
  'SmartyToken',
  function ($resource, $q, SmartyToken) {
...
angular.module('org.crossroads.smartyStreets.controllers', [
  'org.crossroads.smartyStreets.services',
...
angular.module('org.crossroads.smartyStreets.controllers').controller('AddressFormController', [
  '$scope',
  'SmartyStreetsSuggestionFactory',
  'SmartyStreetsValidationFactory',
...
angular.module('CrossroadsUserForm', ['org.crossroads.smartyStreets']).controller('CrossroadsUserFormController', [
  '$scope',
  function ($scope) {
    $scope.form = { address: {} };
